          ...
          child: Drawer(
            ...
            child: Container(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  logFirebaseEvent('HOMEPAGE_PAGE_Column_irejt9bm_ON_TAP');
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent('HOMEPAGE_PAGE_close_ICN_ON_TAP');
                            logFirebaseEvent(
                    ...
                    Align(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'HOMEPAGE_PAGE_Container_wdwb07gq_ON_TAP');
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'HOMEdrag_handle_rounded_ICN_ON_TAP');
                          ...
                          child: Builder(
                            builder: (context) => Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'HOMEPAGE_PAGE_Icon_wekm27nh_ON_TAP');
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'HOMEPAGE_PAGE_Icon_vek614xe_ON_TAP');
                                  ...
                                  itemBuilder: (context, itemsIndex) {
                                    ...
                                    return Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'HOMEPAGE_PAGE_Container_65i0ari8_ON_TAP');
                                          logFirebaseEvent(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'HOMEPAGE_PAGE_Image_mr9mx4td_ON_TAP');
